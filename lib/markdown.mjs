...
/**
 * Header cells of the first markdown table under a heading matching `headingRe`,
 * or [] when the heading or table is absent. Callers that resolve columns by
 * name need this; `tableUnder` deliberately drops it.
 */
export function tableHeaderUnder(text, headingRe) {
