...
```bash
npm i -D github:danhnguyeen/openspec#v0.2.1
...
```
  MODIFIED LOCALLY  .okf/templates/feature.template.md  -> skipped
```
...
| `openspec/config.yaml` | `.okf/INDEX.md` (generated by `okf index`) |
| `.okf/templates/**`, `.okf/README.md` | everything in `CLAUDE.md` / `AGENTS.md` outside the markers |
...
```bash
node test/run.mjs   # 44 fixture tests, no dependencies
