...
Detect OKF entries whose code changed after they were last verified, so drift
from work that never opened an OpenSpec change - hotfixes, refactors, dependency
bumps - becomes visible instead of accumulating silently.
